...
// Ana renkler
  ...
  static const Color cardSecondary = Color(0xFF334155);
  static const Color textPrimary = Colors.white;
  static const Color textSecondary = Color(0xFFB1B5C3);

  static const Color copyButton = Colors.blue; // Mavi
  static const Color shareButton = Colors.green; // Yeşil
  static const Color emailButton = Colors.orange; // Turuncu
  static const Color retryButton = Colors.blue; // Mavi

  static const Color successColor = Color(0xFF10B981); // Yeşil başarı
  static const Color errorColor = Color(0xFFEF4444); // Kırmızı hata
  static const Color warningColor = Color(0xFFF59E0B); // Sarı uyarı

  static const Color disabledBackground = Color(0xFF374151);
